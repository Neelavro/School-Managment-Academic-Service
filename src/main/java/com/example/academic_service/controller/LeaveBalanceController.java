...
public class LeaveBalanceController {
    ...
    public ResponseEntity<ApiResponse> getMyBalances(Authentication auth) {
        ...
        List<LeaveBalance> existing = balanceRepository.findByStaff_IdAndYear(staffId, year);
    ...
    public ResponseEntity<ApiResponse> getForStaffCurrentYear(@PathVariable Long staffId) {
        int year = LocalDate.now().getYear();
        return ResponseEntity.ok(new ApiResponse("OK", balanceRepository.findByStaff_IdAndYear(staffId, year)));
    }
